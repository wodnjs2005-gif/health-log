...
begin
  for f in select p.oid::regprocedure sig from pg_proc p
           where p.pronamespace = 'public'::regnamespace
             and p.proname = any(array['_clean_days','_gid','_j_ex','_j_lesson','_j_meal','_j_member','_j_member_staff','_j_member_trainer','_j_prog','_j_trainer','_j_view','_kst_today','_lesson_data','_mid','_need_admin','_need_staff','_new_code','_new_session','_new_trainer_code','_norm_rank','_role','_staff_ok','_token_hash','admin_add_trainer','admin_change_password','admin_create','admin_del_trainer','admin_login','admin_new_trainer_code','admin_set_trainer_rank','guardian_get','staff_add_lesson','staff_add_member','staff_add_program','staff_check','staff_del_lesson','staff_del_member','staff_del_program','staff_get','staff_login','staff_logout','staff_new_code','staff_new_guardian_code','staff_set_attendance','staff_set_birth','staff_set_offday','staff_set_program_members','staff_set_tags','staff_update_lesson','trainer_login','user_add_ex','user_add_meal','user_add_view','user_del_ex','user_del_meal','user_get'])
  loop
